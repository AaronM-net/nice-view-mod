...
#ifndef LV_ATTRIBUTE_IMG_AGIF2OPT
#define LV_ATTRIBUTE_IMG_AGIF2OPT
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_AGIF2OPT uint8_t agif2opt_map[] = {
  #if CONFIG_NICE_VIEW_WIDGET_INVERTED
        0xff, 0xff, 0xff, 0xff, /*Color of index 0*/
        0x00, 0x00, 0x00, 0xff, /*Color of index 1*/
  #else
